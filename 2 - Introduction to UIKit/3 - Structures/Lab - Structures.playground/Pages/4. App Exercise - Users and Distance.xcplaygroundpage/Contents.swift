...
var PrinceVasoya = User(name: "Prince vasoya", age: 20, height: 67, weight: 62.0, activtyLevel: 9)
print("User name  \(PrinceVasoya.name) of age \(PrinceVasoya.age) and height \(PrinceVasoya.height) and weight \(PrinceVasoya.weight) is at activity level \(PrinceVasoya.activtyLevel)")
/*:
