...
var favoriteBook = Book(title: "Heartstopper", author: "IDK", pages: 900, price: 799.0)
print(" I recenyl recived \(favoriteBook.title) by \(favoriteBook.author) it is of \(favoriteBook.pages) and costed me around \(favoriteBook.price)")
/*:
